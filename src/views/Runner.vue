...
export default {
    ...
    data(){
        return {
            ...
            indNewLine: 0,
            landslide: [
                ...Array.from({ length: 38 }, () => Array(12).fill("")),
                Array(40).fill("B"),
                Array(40).fill("B"),
            ],
            SEGMENT_FLAT: [
            ...
            SEGMENT_TWO_OBSTACLES: [
                ...Array.from({ length: 38 }, () => Array(12).fill("")),
                ["B","B","O","B","B","B","O","B","B","B","B","B"],
                Array(12).fill("B"),
            ],
            SEGMENT_SMALL_GAP: [
                ...Array.from({ length: 38 }, () => Array(12).fill("")),
            ...
            SEGMENT_GAP_OBSTACLE: [
                ...Array.from({ length: 38 }, () => Array(12).fill("")),
                ["B","B","B","","","B","O","B","B","B","B","B"],
                ["B","B","B","","","B","B","B","B","B","B","B"],
                ],
            SEGMENT_STEP_UP: [
                ...Array.from({ length: 36 }, () => Array(12).fill("")),
                ["","","","","","","","","","","",""],
                ["","","","","B","B","B","B","B","B","B","B"],
            ...
            SEGMENT_DOUBLE_OBSTACLE: [
                ...Array.from({ length: 38 }, () => Array(12).fill("")),
                ["B","B","B","O","O","B","B","B","B","B","B","B"],
                Array(12).fill("B"),
            ],
            SEGMENT_BIG_GAP: [
                ...Array.from({ length: 38 }, () => Array(12).fill("")),
    ...
    methods: {
        ...
        // Dessin
        draw() {
            const EASY_SEGMENTS = this.mergeSegmentsHorizontally([
                this.SEGMENT_FLAT,
                this.SEGMENT_TWO_OBSTACLES,
                this.SEGMENT_SMALL_GAP,
            ]);

            console.log(EASY_SEGMENTS)
            this.numFrame += 1
            ...
            if (this.numFrame % 2 == 1){
                let newLine = this.takeNewCol(EASY_SEGMENTS, this.indNewLine)
                this.indNewLine += 1
                if (this.indNewLine == this.gridSize-1) this.indNewLine = 0
                        ...
                        if (this.pos == this.gridSize-1) {
                            ...
                            if (this.numFrame%2 == 0){
                                ...
                                if (this.saut){
                                    ...
                                    this.drawRect(j, this.pos, "green")
                                    if (this.hautSaut == 10) this.ascendSaut = false
